...
class stringsAdv{
    ...
    public static void firstHalfVCount_SecondHalfVCount(String s){
        ...
        /**
         * for(int i = 0; i<n/2; i++){
            if("aeiou".indexOf(s.charAt(i)) != -1) v1count++;
        }
        for(int i = n/2;i<n; i++){
         ...
         */
        while(left < right){
            if("aeiou".indexOf(s.charAt(left)) != -1 && left != right) v1count++;
            if("aeiou".indexOf(s.charAt(right)) != -1) v2count++;
            left++;
            right--;
        }
    ...
    public static void vowelsExperiments(String s){
        ...
        for(int i = 0; i< s.length(); i++){
            char ch = s.charAt(i);
            if("aeiou".indexOf(ch) != -1) System.out.print(Character.toUpperCase(ch));
        ...
        for(int i = 0; i<s.length(); i++){
            if(i%2 == 0) System.out.print(Character.toUpperCase(s.charAt(i)));
    ...
    public static void areAnagrams(){
        ...
        Arrays.sort(s11);
        Arrays.sort(s22);
        if(Arrays.equals(s11, s22)) System.out.println("Anagrams");
